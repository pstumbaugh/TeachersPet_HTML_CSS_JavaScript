...
function sendThumbnailToExchange() {
    amqp.connect(credentials.AMPQserver, function (error0, connection) {
        ...
        connection.createChannel(function (error1, channel) {
            ...
            fs.readFile(
                "thumbnail" + counterModule.imageCounter + ".jpg",
                function (err, data) {
                    ...
                    channel.publish(
                        exchange,
                        "",
                        Buffer.from(JSON.stringify(counterModule.imageCounter))
                    );
                    counterModule.imageCounter = counterModule.imageCounter + 1;
...
function saveImageFromURL(url) {
    ...
    const options = {
        url: url,
        dest: "thumbnail" + counterModule.imageCounter + ".jpg", //where it will be saved at
    };
    ...
    download
        ...
        .finally(function () {
            ...
            sharp("thumbnail" + counterModule.imageCounter + ".jpg")
